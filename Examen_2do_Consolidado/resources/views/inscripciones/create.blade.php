                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('inscripciones.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="fecha_inscripcion" name="fecha_inscripcion" type="date" value="{{ date('Y-m-d') }}" required>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('inscripciones.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                                Cancelar
                            </a>
                        </div>
                    </form>
